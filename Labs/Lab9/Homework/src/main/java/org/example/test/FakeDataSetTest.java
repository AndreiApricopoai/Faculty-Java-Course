...
public class FakeDataSetTest {
    ...
    void insertFakeData(){
        ...
        System.out.println("Inserted 500 artists and 500 albums in " + Duration.between(start, finish).toMillis() + " milliseconds");

        Assertions.assertEquals(500, artists.size());
        Assertions.assertEquals(500, albums.size());
    }
