...
public class Main {
    public static void main(String[] args) {
        ...
        // Aici cream TreeSet de Project folosind stream-uri, sortam(oricum e sortat deoarce e TreeSet) stream-ul obtinut si il convertim inapoi in TreeSet.
        ...
        // Aici afisam lista folosind un forEach si referinta a metodei println.
        projects.forEach(System.out::println);



        // Aici cream LinkedList de Student folosind stream-uri, sortam stream-ul obtinut si il convertim inapoi in LinkedList.
